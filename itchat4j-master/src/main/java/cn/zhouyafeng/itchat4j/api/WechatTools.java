...
//		MessageTools.sendMsgById(result, core.getMsgList().get(0).getFromUserName());
	...
	public static void sendMsgByNickName(String msg, String nick_name) {
		MessageTools.sendMsgByNickName(msg, nick_name);
//		sendMsgByNickName()
	}

	public static String getGroupUserNameByGroupNickName(String groupName) {
//		for (JSONObject o : core.getContactList()) {
//			if (o.getString("NickName").equals(nickName)) {
//				return o.getString("UserName");
//			}
...
//		return null;
		String ans = null;
		List<JSONObject> groups = getGroupList();
		for (JSONObject a_group: groups
			 ) {
			if (a_group.getString("NickName").equals(groupName)){
				return a_group.getString("UserName");
			}
		}
		return ans;
	}
